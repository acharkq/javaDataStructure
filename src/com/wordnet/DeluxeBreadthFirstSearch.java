 ...
 *  @author Kevin Wayne
 */
public class DeluxeBreadthFirstSearch {
    private static final int INFINITY = Integer.MAX_VALUE;
    private boolean[] marked;  // marked[v] = is there an s->v path?
    private int[] edgeTo;      // edgeTo[v] = last edge on shortest s->v path
    private int[] distTo;      // distTo[v] = length of shortest s->v path
    private Digraph G;
    private Stack<Integer> position; // the positions that the arrays have changed
     ...
     */
    public DeluxeBreadthFirstSearch(Digraph G) {
    ...
    public void init(Iterable<Integer> sources){
        init();
    ...
    public static void main(String[] args) {
        ...
        DeluxeBreadthFirstSearch bfs = new DeluxeBreadthFirstSearch(G);
        bfs.init(s);
